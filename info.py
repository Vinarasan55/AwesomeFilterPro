...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002009528150 -1001876787699').split()]
...
#Sample
SHORTNER_SITE = "publicearn.in"
SHORTNER_API = "9672acfd41f4778f06adb1c63d6a241f0c546954"
